...
- If a tool call fails with an authentication or connection error, check that `SUZIEQ_API_KEY`, `SUZIEQ_API_URL` are set and valid before assuming a data or device problem.
