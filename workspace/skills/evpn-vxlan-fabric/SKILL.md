...
- If a tool call fails with an authentication or connection error, check that `PYATS_TESTBED_PATH` is set and valid before assuming a data or device problem.
